...
import { SVisaLogo } from './styles';
import { TVisaLogoProps } from './types';
...
const VisaLogo = ({
  ...
  const clipId = `visaLogoClip-${uid}`;
  const realistic = variant === 'realistic';
  const gradientId = realistic ? `visaLogoGradient-${uid}` : undefined;
