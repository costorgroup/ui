...
const neonPulse = keyframes`
  ...
  100% {
    box-shadow:
      0 0 12px -2px color-mix(in srgb, var(--neon-color) 65%, transparent),
      0 0 0 0 color-mix(in srgb, var(--neon-color) 35%, transparent);
    opacity: 0.85;
  }

  50% {
    box-shadow:
      0 0 24px 2px color-mix(in srgb, var(--neon-color) 80%, transparent),
      0 0 48px 8px color-mix(in srgb, var(--neon-color) 45%, transparent);
    opacity: 1;
  }
`;
...
export const SNeonRing = styled.span`
  ...
  box-shadow: 0 0 14px -2px color-mix(in srgb, var(--neon-color) 70%, transparent);
`;
